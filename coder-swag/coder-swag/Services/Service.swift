...
class DataService{
    ...
    private let hats = [Product(title: "Devslopes logo Graphics Beanie", price: "$18", imageName:"hat01.png"),
                        Product(title: "Devslopes Logo Hat Black", price: "$22", imageName: "hat02.png"),
                        Product(title: "Devslopes Logo Hat Black", price: "$33", imageName: "hat03.png"),
